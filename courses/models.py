...
class Section(models.Model):
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, null=True, verbose_name=_('course section'))
    position = models.IntegerField(verbose_name=_('section number'))

    def __str__(self):
        return '%s - %s' % (self.position, self.course)
...
class Lesson(models.Model):
    ...
    section = models.ForeignKey(Section, on_delete=models.SET_NULL, null=True,
                                verbose_name=_('section to which belongs the course'))
